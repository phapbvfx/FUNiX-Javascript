...
class User {
  ...
  static async searchAnyThing(key, pageSize = 5, page = 1) {
    try {
      const url = `https://newsapi.org/v2/everything?q=${key}&pageSize=${pageSize}&page=${page}&apiKey=f21185821b6b419192b91a8dfdd20041`;
